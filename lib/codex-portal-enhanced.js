...
const CODEX_APPS = [
  {
    id: "polywrite",
    name: "PolyWrite",
    href: "apps/polywrite/index.html",
    icon: "📝",
    category: "Writing",
  ...
  },
  {
    id: "pearl",
    name: "Pearl",
    href: "apps/pearl/index.html",
    icon: "📜",
    category: "Writing",
    description: "Layered academic writing environment. Citations, footnotes, sources in nacre-formed strata.",
    status: "stable",
  ...
  },
  {
    id: "vault",
    name: "Vault",
    href: "apps/vault/index.html",
    icon: "🔐",
    category: "Security",
    description: "Portable secret store. MK envelope architecture with YubiKey/keyfile support.",
    status: "stable",
    shortcuts: ["vault-v2 unlock", "vault-v2 show <path>"]
  },
  {
    id: "din-files",
    name: "DIN Files",
  ...
  },
  {
    ...
    href: "apps/pranayama/index.html",
    icon: "🌬️",
    category: "Body",
